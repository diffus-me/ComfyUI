...
def prompt_worker(q, server_instance, task_dispatcher):
    ...
    while True:
        ...
        if queue_item is not None:
            ...
            logging.info(f"Prompt executed in {execution_time:.2f} seconds, client_id: {server_instance.client_id}")
...
def start_comfyui(asyncio_loop=None):
    ...
    threading.Thread(target=prompt_worker, daemon=True, args=(q, prompt_server, task_dispatcher,)).start()
