        ...
        if queue_item is not None:
            ...
            if server.client_id is not None:
                ...
                if monitor_error is not None:
                    ...
                    server.send_sync("finished",  { "node": None, 'prompt_id': prompt_id, 'used_time': end - begin, 'subscription_consumption': extra_data.get('subscription_consumption', 0) }, server.client_id)
