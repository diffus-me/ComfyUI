...
def _sample_consumption_ratio(
    ...
    if model_name and (
        ...
        if count > 100:
            ...
            ratio *= 0.5
    elif model_name and model_name.startswith("minimax_h3"):
        if count > 100:
            ratio *= 0.4
        elif count > 50:
            ratio *= 0.6
...
def __sample_opt_from_latent(context: execution_context.ExecutionContext, model, latent_image, steps):
    ...
    return {
        ...
        "ratio": _sample_consumption_ratio(context, model, batch_size, n_iter),
        "model_name": _get_model_name(context, model, ),
    }
...
def _sampler_custom_consumption(
        model,
        add_noise,
        noise_seed,
        cfg,
    ...
    return {'opts': [__sample_opt_from_latent(exec_context, model, latent_image, steps, )]}
...
def _sampler_custom_advanced_consumption(noise, guider, sampler, sigmas, latent_image,
    ...
    steps = len(sigmas)
    return {'opts': [__sample_opt_from_latent(exec_context, guider.model_patcher, latent_image, steps, )]}
...
def _was_k_sampler_cycle_consumption(model, seed, steps, cfg, sampler_name, scheduler, positive, negative, latent_image,
    ...
    n_iter = len(latent_image.get("batch_index", [0]))
...
def _searge_sdxl_image2image_sampler2_consumption(base_model, base_positive, base_negative, refiner_model,
    ...
    result.append({
        ...
        'n_iter': n_iter,
        'batch_size': batch_size,
        'ratio': _sample_consumption_ratio(context, base_model, batch_size, n_iter),
...
_NODE_CONSUMPTION_MAPPING = {
    ...
    "SeedVR2LoadDiTModel": _none_consumption_maker,
    "SeedVR2LoadVAEModel": _none_consumption_maker,

    "MatAnyoneVideoMatting": _mat_anyone_video_matting_consumption,
    "Kytra_Images_To_RGB": _none_consumption_maker,

    "ResolutionSelector": _none_consumption_maker,
    "MiniMaxH3ImageToVideo": _none_consumption_maker,
    "MiniMaxH3ReferenceToVideo": _none_consumption_maker,
    "ComfyMathExpression": _none_consumption_maker,
    "PrimitiveFloat": _none_consumption_maker,
    "VAEDecodeAudio": _none_consumption_maker,
    "ModelSamplingAuraFlow": _none_consumption_maker,

    "NunchakuFluxDiTLoader": _none_consumption_maker,
    "NunchakuFluxLoraLoader": _none_consumption_maker,
    "NunchakuTextEncoderLoaderV2": _none_consumption_maker,

    "LayerUtility: ImageBlendAdvance V2": _none_consumption_maker,
    "LayerUtility: ImageRemoveAlpha": _none_consumption_maker,
    "LayerMask: SegformerClothesPipelineLoader": _none_consumption_maker,
    "ImageResizeKJv2": _none_consumption_maker,
    "PrimitiveStringMultiline": _none_consumption_maker,
    "EmptyFlux2LatentImage": _none_consumption_maker,
    "Flux2Scheduler": _none_consumption_maker,
    "PrimitiveInt": _none_consumption_maker,
    "PreviewAny": _none_consumption_maker,
    "ManualSigmas": _none_consumption_maker,

    "ADE_StandardUniformContextOptions": _none_consumption_maker,
    "ImpactCombineConditionings": _none_consumption_maker,
    "BatchPromptScheduleLatentInput": _none_consumption_maker,
    "ADE_EmptyLatentImageLarge": _none_consumption_maker,
    "GrowMask": _none_consumption_maker,

    "LTXVAudioVAEDecode": _none_consumption_maker,
    "LTXVConcatAVLatent": _none_consumption_maker,
    "LTXVSeparateAVLatent": _none_consumption_maker,
    ...
    "ResizeImagesByLongerEdge": _none_consumption_maker,
    "ResizeImageMaskNode": _none_consumption_maker,
    ...
    "DF_Float": _none_consumption_maker,
    "DF_Integer": _none_consumption_maker,
    "DF_Text": _none_consumption_maker,
    "DF_Text_Box": _none_consumption_maker,
    "DF_DynamicPrompts_Text_Box": _none_consumption_maker,
    "DF_String_Concatenate": _none_consumption_maker,
    "DF_String_Replace": _none_consumption_maker,
    "DF_Search_In_Text": _none_consumption_maker,
    "DF_To_text_": _none_consumption_maker,
    "DF_Random": _none_consumption_maker,
    "DF_Int_to_Float": _none_consumption_maker,
    "DF_Ceil": _none_consumption_maker,
    "DF_Floor": _none_consumption_maker,
    "DF_Absolute_value": _none_consumption_maker,
    "DF_Get_latent_size": _none_consumption_maker,
    "DF_Get_image_size": _none_consumption_maker,
    "DF_Sum": _none_consumption_maker,
    "DF_Subtract": _none_consumption_maker,
    "DF_Multiply": _none_consumption_maker,
    "DF_Divide": _none_consumption_maker,
    "DF_Power": _none_consumption_maker,
    "DF_Square_root": _none_consumption_maker,
    "DF_Sinus": _none_consumption_maker,
    "DF_Cosines": _none_consumption_maker,
    "DF_Tangent": _none_consumption_maker,
    "DF_Logic_node": _none_consumption_maker,
    "DF_Latent_Scale_by_ratio": _none_consumption_maker,
    "DF_Latent_Scale_to_side": _none_consumption_maker,
    ...
    "Context Big (rgthree)": _none_consumption_maker,
    "Context (rgthree)": _none_consumption_maker,
    "Context Switch (rgthree)": _none_consumption_maker,
    "Context Switch Big (rgthree)": _none_consumption_maker,
    "Context Merge (rgthree)": _none_consumption_maker,
    "Context Merge Big (rgthree)": _none_consumption_maker,
    "Display Int (rgthree)": _none_consumption_maker,
    "Display Any (rgthree)": _none_consumption_maker,
    "Lora Loader Stack (rgthree)": _none_consumption_maker,
    "Seed (rgthree)": _none_consumption_maker,
    "Image Inset Crop (rgthree)": _none_consumption_maker,
    "Power Prompt (rgthree)": _none_consumption_maker,
    "Power Prompt - Simple (rgthree)": _none_consumption_maker,
    "KSampler Config (rgthree)": _none_consumption_maker,
    "SDXL Empty Latent Image (rgthree)": _none_consumption_maker,
    "SDXL Power Prompt - Positive (rgthree)": _none_consumption_maker,
    "SDXL Power Prompt - Simple / Negative (rgthree)": _none_consumption_maker,
    "Any Switch (rgthree)": _none_consumption_maker,
    "Image Comparer (rgthree)": _none_consumption_maker,
    "Power Lora Loader (rgthree)": _none_consumption_maker,
    "Power Primitive (rgthree)": _none_consumption_maker,
    ...
    "Frame Set Reindex [DVB]": _none_consumption_maker,
    "Frame Set Index Offset [DVB]": _none_consumption_maker,
    "Calculation [DVB]": _none_consumption_maker,
    "Multiply [DVB]": _none_consumption_maker,
    "Divide [DVB]": _none_consumption_maker,
    "Frame Set Splitter [DVB]": _none_consumption_maker,
    "Float Input [DVB]": _none_consumption_maker,
    "Int Input [DVB]": _none_consumption_maker,
    "Text Input [DVB]": _none_consumption_maker,
    "String Input [DVB]": _none_consumption_maker,
    "Create Frame Set [DVB]": _none_consumption_maker,
    "Blended Transition [DVB]": _none_consumption_maker,
    "Unwrap Frame Set [DVB]": _none_consumption_maker,
    "Frame Set Append [DVB]": _none_consumption_maker,
    "Frame Set Merger [DVB]": _none_consumption_maker,
    "Fade From Black [DVB]": _none_consumption_maker,
    "Fade To Black [DVB]": _none_consumption_maker,
    "Linear Camera Pan [DVB]": _none_consumption_maker,
    "Sine Camera Pan [DVB]": _none_consumption_maker,
    "Linear Camera Zoom [DVB]": _none_consumption_maker,
    "Sine Camera Zoom [DVB]": _none_consumption_maker,
    "Linear Camera Roll [DVB]": _none_consumption_maker,
    "Sine Camera Roll [DVB]": _none_consumption_maker,
    "Generate Inbetween Frames [DVB]": _none_consumption_maker,
    "For Each Filename [DVB]": _none_consumption_maker,
    "For Each Done [DVB]": _none_consumption_maker,
    "Load Image From Path [DVB]": _none_consumption_maker,
    "Frame Set Reverse [DVB]": _none_consumption_maker,
    "Frame Set Repeat [DVB]": _none_consumption_maker,
    "Frame Set Frame Dimensions Scaled [DVB]": _none_consumption_maker,
    "Frame Set Split Beginning [DVB]": _none_consumption_maker,
    "Frame Set Split End [DVB]": _none_consumption_maker,
}
