...
def _filter_favorite_model_by_model_type(query: Query, user_id: str, model_type: str, model_base) -> Query:
    ...
    return _filter_model_by_model_type(query, model_type, model_base)


def _filter_model_by_model_type(query: Query, model_type: str, model_base) -> Query:
