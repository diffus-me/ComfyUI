...
class QuadrupleCLIPLoader:
    ...
    def INPUT_TYPES(s, context: execution_context.ExecutionContext):
        return {"required": { "clip_name1": (folder_paths.get_filename_list(context, "text_encoders"), ),
                              ...
                              "clip_name3": (folder_paths.get_filename_list(context, "text_encoders"), ),
                              "clip_name4": (folder_paths.get_filename_list(context, "text_encoders"), )
                             },
    ...
    def load_clip(self, clip_name1, clip_name2, clip_name3, clip_name4, context: execution_context.ExecutionContext):
        ...
        clip_path3 = folder_paths.get_full_path_or_raise(context, "text_encoders", clip_name3)
        clip_path4 = folder_paths.get_full_path_or_raise(context, "text_encoders", clip_name4)
