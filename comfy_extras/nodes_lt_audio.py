...
class LTXAVTextEncoderLoader(io.ComfyNode):
    ...
    @classmethod
    def execute(cls, text_encoder, ckpt_name, device="default", exec_context: execution_context.ExecutionContext=None):
        clip_type = comfy.sd.CLIPType.LTXV

        clip_path1 = folder_paths.get_full_path_or_raise(exec_context, "text_encoders", text_encoder)
        clip_path2 = folder_paths.get_full_path_or_raise(exec_context, "checkpoints", ckpt_name)
