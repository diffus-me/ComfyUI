...
def _load_existing_lora(exec_context: execution_context.ExecutionContext, existing_lora):
    ...
    lora_path = folder_paths.get_full_path_or_raise(exec_context, "loras", existing_lora)
...
class TrainLoraNode(io.ComfyNode):
    ...
    def execute(
        ...
        with torch.inference_mode(False):
            ...
            # Load existing LoRA weights if provided
            existing_weights, existing_steps = _load_existing_lora(exec_context, existing_lora)
