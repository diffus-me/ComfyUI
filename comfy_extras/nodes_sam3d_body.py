...
class SAM3DBody_Loader(io.ComfyNode):
    ...
    @classmethod
    def execute(cls, model_file, exec_context: execution_context.ExecutionContext) -> io.NodeOutput:
        path = folder_paths.get_full_path_or_raise(exec_context, "detection", model_file)
