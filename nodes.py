...
class CheckpointLoader:
    ...
    def load_checkpoint(self, config_name, ckpt_name, output_vae=True, output_clip=True, context=None):
...
class DualCLIPLoader:
    @classmethod
    def INPUT_TYPES(s, context: execution_context.ExecutionContext):
        return {"required": { "clip_name1": (folder_paths.get_filename_list(context, "clip"), ), "clip_name2": (folder_paths.get_filename_list(context, "clip"), ),
                             },
                "hidden": {"context": "EXECUTION_CONTEXT"}}
    RETURN_TYPES = ("CLIP",)
    FUNCTION = "load_clip"
    ...
    def load_clip(self, clip_name1, clip_name2, context: execution_context.ExecutionContext):
